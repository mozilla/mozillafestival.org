...
<div id="content" class="splash-2014 proposal-listings">
  <div class="constrained">
    ...
    <section class="session expanded">
      <header>
        <h3>Session Title</h3>
    ...
    <section class="session">
      <header>
        <h3>Another Session Title</h3>
        <p class="excerpt">This is also small preview of the summary, but with some more text.</p>
      </header>
      <article>
        <h4>Subheading</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem, illo, nemo impedit delectus cum tempora fugit repellendus illum fugiat dolorum. Rem molestias at voluptas laboriosam expedita totam accusantium ipsa temporibus.</p>
    ...
    <section class="session">
      <header>
        <h3>Yet Another Session Title</h3>
        <p class="excerpt">Who doesn't love a little bit of cupcake ipsum?</p>
      </header>
      <article>
        <h4>Subheading</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem, illo, nemo impedit delectus cum tempora fugit repellendus illum fugiat dolorum. Rem molestias at voluptas laboriosam expedita totam accusantium ipsa temporibus.</p>
