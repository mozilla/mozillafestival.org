...
<div id="content">
  <div class="constrained">
    ...
    <div class="panel">
      <div class="header">
        <h2>About the Mozilla Festival</h2>
      </div>
      <blockquote class="major">
        <h4 class="intro-large">Dear Webmakers,</h4>
        <h4>Help us build a truly global web.</h4>
        <p>
        ...
        <p class="vcard">
          <img class="headshot photo" title="" src="//2014.mozillafestival.org/wp-content/uploads/2012/08/surman-head.jpg" alt="Mark Surman" />
          <em>— <span class="fn">Mark Surman</span>, <span class="role">Executive Director</span> of <span class="org">Mozilla</span></em>
        </p>
...
MozFest 2014 will be Sarah's second festival.
    ...
    <div class="panel">
      ...
      <h4>A History of MozFest</h4>
      <p>
        Mozfest started in 2010 as the Drumbeat Festival in Barcelona. Dedicated to finding, energizing and creating a community of people working with technology to build participation, understanding and control into Internet life, the Drumbeat Festival focused on the pillars of Mozilla at the time: working in the open, smart crowdsourcing and open innovation, and lots of local and regional communities and gatherings.
      </p>
      <p>
        Over the last 4 years more than 3,300 people from 51 countries have collaborated at MozFest to shape the future of the web. Join us in 2014 as we celebrate what we've achieved so far, and cast our eyes forward to what we can do next.
      </p>
    </div>
