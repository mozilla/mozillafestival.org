<?php
/**
 * Template Name: Homepage - after the festival
 *
...
get_header(); ?>
		...
		<div id="primary" class="one_col">
    		<div id="content" role="main">
                                <section>
                    <h2 class="entry-title">Coverage</h2>
                    <ol class="grid">
                    <?php
                ...
                <section class="buzz">
                    <h2 class="entry-title">What happened</h2>
                    <div>
                ...
                <p>The students at Ravensbourne are provide festival coverage on the following topics:</p>
                <ul>
                 <li>
               ...
               <li>
                ...
                <section>
                    <h2 class="entry-title">Who came?</h2>
                ...
                <section class="partnerships">
                    ...
                    <footer>
                 <a href="https://mozillafestival.org/supporters/" class="register">See our full list of supporters</a>
                 </footer>
               </section>
			</div><!-- #content -->
		</div><!-- #primary -->
