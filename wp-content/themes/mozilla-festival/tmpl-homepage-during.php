...
get_header(); ?>
		...
		<div id="primary" class="one_col">
			...
			<div id="content" role="main">
                <section class="buzz">
                    <h2 class="entry-title">Latest Festival news</h2>
                    <div>
                ...
                <p>The students at Ravensborne have been set the challenge to provide festival coverage. If you're looking for information on the following subjects then see what they've found:</p>
                <ul>
                 <li>
               ...
               <li>
                ...
                <section>
                    <h2 class="entry-title">From the blog</h2>
                    <ol class="grid">
                    <?php
