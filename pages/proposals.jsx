      ...
      <div className="proposals-page">
        ...
        <div className="content">
          <div className="proposals-form">
            ...
            <div id="generic-error" className="error-message">Uh oh! There's an unknown error with your session proposal. Please try again later, or email [address] for help.</div>
          </div>
        </div>
        <Footer/>
      </div>
