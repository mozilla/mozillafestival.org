      ...
      <div className="volunteer-page">
        ...
        <div className="white-background">
          <div className="content centered wide">
            <h1 className="expect-header">How the MozFest Spaces Work</h1>
            <p>To help you get the most out of MozFest, we organize the program into two formats: Spaces and Pathways.</p>
            <p>Spaces are physical hubs, typically located on a single floor in the venue, that explore a big theme throughout the festival.</p>
            <p>Pathways are series of sessions, often appearing across several floors, that are tailored for participants to learn a set of skills.</p>
