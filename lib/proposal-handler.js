  ...
  request(
    ...
    function(err,response,body) {
      if (err) {
        ...
        console.log("Successfully posted to GitHub: Issue #" + body.number + ", " + issue.title);
        // TODO:FIXME: send email confirmation?
        // sendConfirmationEmail(body.html_url)
        callback(null);
      }
    }
  );
...
function sendConfirmationEmail(urlToIssue) {
  // use hatchet to send???
}
